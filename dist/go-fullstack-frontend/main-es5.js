...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    var AuthService = /*#__PURE__*/function () {
      ...
      _createClass(AuthService, [{
        ...
        value: function createNewUser(email, password) {
          ...
          return new Promise(function (resolve, reject) {
            _this17.http.post('http://localhost:3000/api/auth/signup', {
              email: email,
              password: password
            }).subscribe(function () {
        ...
        value: function login(email, password) {
          ...
          return new Promise(function (resolve, reject) {
            _this18.http.post('http://localhost:3000/api/auth/login', {
              email: email,
              password: password
    ...
    var StuffService = /*#__PURE__*/function () {
      ...
      _createClass(StuffService, [{
        ...
        value: function getStuff() {
          ...
          this.http.get('http://localhost:3000/api/stuff').subscribe(function (stuff) {
            if (stuff) {
              _this19.stuff = stuff;
        ...
        value: function getThingById(id) {
          ...
          return new Promise(function (resolve, reject) {
            _this20.http.get('http://localhost:3000/api/stuff/' + id).subscribe(function (response) {
              resolve(response);
            }, function (error) {
              reject(error);
            });
        ...
        value: function createNewThing(thing) {
          ...
          return new Promise(function (resolve, reject) {
            _this21.http.post('http://localhost:3000/api/stuff', thing).subscribe(function (response) {
              resolve(response);
            }, function (error) {
              reject(error);
            });
        ...
        value: function createNewThingWithFile(thing, image) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this22.http.post('http://localhost:3000/api/stuff', thingData).subscribe(function (response) {
              resolve(response);
            }, function (error) {
              reject(error);
            });
        ...
        value: function modifyThing(id, thing) {
          ...
          return new Promise(function (resolve, reject) {
            _this23.http.put('http://localhost:3000/api/stuff/' + id, thing).subscribe(function (response) {
              resolve(response);
            }, function (error) {
              reject(error);
            });
        ...
        value: function modifyThingWithFile(id, thing, image) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this24.http.put('http://localhost:3000/api/stuff/' + id, thingData).subscribe(function (response) {
              resolve(response);
            }, function (error) {
              reject(error);
            });
        ...
        value: function deleteThing(id) {
          ...
          return new Promise(function (resolve, reject) {
            _this25.http["delete"]('http://localhost:3000/api/stuff/' + id).subscribe(function (response) {
              resolve(response);
            }, function (error) {
              reject(error);
            });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\NITT\Desktop\Projects\Full-stack\frontend\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
